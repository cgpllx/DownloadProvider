...
class RealSystemFacade implements SystemFacade {
	...
	public static ScheduledThreadPoolExecutor downloadthreadPoolExecutor = new ScheduledThreadPoolExecutor(2);//下载app用的线程池

	@Override
	public void startThread(Thread thread) {
		downloadthreadPoolExecutor.execute(thread);
		//		Assist.downloadthreadPoolExecutor.

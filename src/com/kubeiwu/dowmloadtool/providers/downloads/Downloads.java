...
public final class Downloads implements BaseColumns {
	 ...
	 */
	public static final String AUTHORITY = "com.konka.appdownload.downloads";
	 ...
	 * @hide
	 */
	public static final String PERMISSION_ACCESS = "com.konka.appdownload.permission.ACCESS_DOWNLOAD_MANAGER";
	 ...
	 * @hide
	 */
	public static final String PERMISSION_ACCESS_ADVANCED = "com.konka.appdownload.permission.ACCESS_DOWNLOAD_MANAGER_ADVANCED";

	/**
	 * The permission to access the all the downloads in the manager.
	 */
	public static final String PERMISSION_ACCESS_ALL = "com.konka.appdownload.permission.ACCESS_ALL_DOWNLOADS";
	 ...
	 * @hide
	 */
	public static final String PERMISSION_SEND_INTENTS = "com.konka.appdownload.permission.SEND_DOWNLOAD_COMPLETED_INTENTS";

	/**
	 * The permission to download files without any system notification being
	 * shown.
	 */
	public static final String PERMISSION_NO_NOTIFICATION = "com.konka.appdownload.permission.DOWNLOAD_WITHOUT_NOTIFICATION";
	...
	public static boolean isStatusSuccess(int status) {
		//cgp 2014 0528
		return status == 2000 || (status >= 200 && status < 300);
		//cgp 2014 0528
	...
	public static boolean isStatusCompleted(int status) {
		//cgp 2014 05 28
		return status == 2000 || (status >= 200 && status < 300) || (status >= 400 && status < 600);
		//cgp 2014 05 28
